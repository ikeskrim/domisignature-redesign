...
Drop level: ?drop=2 on every route (applies at phone widths only).
...
|---|---|---|---|---|---|---|---|---|
| Home | 88 ⚠️ | 88 ⚠️ | **96** | **100** | **100** | 3.4 s | 0.000 | 198 ms |
| Venues | **93** | **93** | **96** | **100** | **100** | 3.1 s | 0.000 | 63 ms |
| Venue detail | **92** | **92** | **96** | **100** | **100** | 3.2 s | 0.001 | 83 ms |
| Signature Events | **93** | **93** | **96** | **100** | **100** | 3.0 s | 0.000 | 76 ms |
| Wedding Guide | **93** | **93** | **95** | **100** | **100** | 3.0 s | 0.000 | 119 ms |
| Contact | **95** | **94** | **96** | **100** | **100** | 2.9 s | 0.000 | 53 ms |
...
Raw output: `design-review/lighthouse-stage6-drop2.json`.
