...
|---|---|---|---|---|---|---|---|
| Home | 84 ⚠️ | **100** | **100** | **100** | 3.9 s | 0 | 150 ms |
| Venues | **91** | **100** | **100** | **100** | 3.2 s | 0 | 30 ms |
| Venue detail | 86 ⚠️ | **100** | **100** | **100** | 3.9 s | 0.001 | 30 ms |
| Signature Events | **92** | **100** | **100** | **100** | 3.1 s | 0 | 40 ms |
| Wedding Guide | **92** | **98** | **100** | **100** | 3.1 s | 0 | 90 ms |
...
Raw output: `design-review/lighthouse-stage5.json`.
