...
Drop level: ?drop=3 on every route (applies at phone widths only).
...
|---|---|---|---|---|---|---|---|---|
| Home | 88 ⚠️ | 87 ⚠️ | **96** | **100** | **100** | 3.3 s | 0.000 | 214 ms |
| Venues | **93** | **93** | **96** | **100** | **100** | 3.1 s | 0.000 | 69 ms |
| Venue detail | **92** | **91** | **96** | **100** | **100** | 3.2 s | 0.001 | 79 ms |
| Signature Events | **93** | **93** | **96** | **100** | **100** | 3.0 s | 0.000 | 72 ms |
| Wedding Guide | **93** | **93** | **95** | **100** | **100** | 3.0 s | 0.000 | 121 ms |
| Contact | **95** | **94** | **96** | **100** | **100** | 2.9 s | 0.000 | 63 ms |
...
Raw output: `design-review/lighthouse-stage6-drop3.json`.
