...
|---|---|---|---|---|---|---|---|---|
| Home | 87 ⚠️ | 86 ⚠️ | **96** | **100** | **100** | 3.3 s | 0.000 | 211 ms |
| Venues | **92** | **92** | **96** | **100** | **100** | 3.1 s | 0.000 | 66 ms |
| Venue detail | **91** | **91** | **96** | **100** | **100** | 3.2 s | 0.001 | 82 ms |
| Signature Events | **92** | **92** | **96** | **100** | **100** | 3.0 s | 0.000 | 72 ms |
| Wedding Guide | **91** | **91** | **95** | **100** | **100** | 3.0 s | 0.000 | 113 ms |
| Contact | **93** | **93** | **96** | **100** | **100** | 2.9 s | 0.000 | 55 ms |
...
Raw output: `design-review/lighthouse-stage7-mobile.json`.
