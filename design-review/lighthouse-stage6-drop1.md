...
Drop level: ?drop=1 on every route (applies at phone widths only).
...
|---|---|---|---|---|---|---|---|---|
| Home | 87 ⚠️ | 87 ⚠️ | **96** | **100** | **100** | 3.4 s | 0.000 | 218 ms |
| Venues | **93** | **93** | **96** | **100** | **100** | 3.1 s | 0.000 | 64 ms |
| Venue detail | **92** | **92** | **96** | **100** | **100** | 3.2 s | 0.001 | 91 ms |
| Signature Events | **94** | **93** | **96** | **100** | **100** | 3.0 s | 0.000 | 77 ms |
| Wedding Guide | **93** | **93** | **95** | **100** | **100** | 3.0 s | 0.000 | 123 ms |
| Contact | **94** | **94** | **96** | **100** | **100** | 2.9 s | 0.000 | 71 ms |
...
Raw output: `design-review/lighthouse-stage6-drop1.json`.
