...
export default function AegeanHero() {
  ...
  return (
    <main>
      ...
      <section className="relative h-[86svh] min-h-[32rem] w-full overflow-hidden bg-ink">
        <Image
        ...
        <div className="relative mx-auto flex h-full w-full max-w-[104rem] flex-col justify-end px-gutter pb-16">
          ...
          <h1 className="mt-6 max-w-4xl font-display text-[clamp(2.75rem,7vw,6.5rem)] font-light leading-[0.95] text-bone">
            {hero.tagline}
          </h1>
        </div>
      </section>
      ...
      <section className="bg-[var(--aegean-ivory)] px-gutter pb-24 pt-24 lg:pb-32 lg:pt-32">
        <div className="mx-auto w-full max-w-[104rem]">
          ...
          <span aria-hidden className="block h-px w-24 bg-[#b98f4a]" />

          <p className="mt-10 max-w-3xl font-display text-[clamp(1.6rem,3vw,2.6rem)] font-light leading-[1.25] text-[var(--aegean-ink)]">
            {hero.subtitle}
          </p>

          <div className="mt-14 h-px w-full bg-[var(--aegean-rule)]" />
          ...
          <div className="mt-14 grid gap-10 sm:grid-cols-3">
            <div>
              ...
              <p className="mt-3 font-display text-[2.4rem] font-light leading-none text-[var(--aegean-ink)]">
            ...
            <div>
              ...
              <p className="mt-3 font-display text-[1.5rem] font-light leading-snug text-[var(--aegean-ink)]">
                {venues.find((v) => v.capacity.includes(String(largest)))?.name}
                <span className="block text-[0.95rem] text-[var(--aegean-stone)]">
                  {capacityLabel(
