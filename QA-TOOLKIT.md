...
| **graffiti** | `scripts/graffiti-check.mjs` | The graffitied rock in the arrival sequence's closing seascape stays inside the ink band at every breakpoint from 390 to ultrawide. Very specific, and it exists because it broke once — a crop that looked right at 1440 put graffiti in the middle of the frame at 390. |
...
`audit:assets`, `audit:a11y`, `audit:graffiti`, `audit:ingest`, `audit:keyboard`,
